  ...
  return (
    <section id='hyperhack' className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        <a href="https://hyperhack.io" target="_blank" rel="noopener noreferrer">
          <img
            src={cvpbadge}
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          <a href="https://hyperhack.io" className="highlight-link">HyperHack</a> is a prominent event where developers and teams compete by building innovative applications on the <a href="https://hyperion.io" className="highlight-link">Hyperion network</a>, an AI-optimized, high-performance Layer 2 solution built on Metis.
        </p>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
