...
import { gmetis } from '../assets' // You might want to replace this with LazaiTrader logo
        ...
        <div className='flex-1 flex flex-col justify-start mr-10'>
          <div className="flex items-center mb-4">
            <img
              ...
              className='w-[72px] h-[72px] object-contain mr-4'
            />
            <span className='font-poppins font-bold text-[32px] text-white'>LazaiTrader</span>
          </div>
